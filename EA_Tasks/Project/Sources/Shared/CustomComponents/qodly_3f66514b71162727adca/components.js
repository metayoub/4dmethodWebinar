...
const initResolve = __mfResolveState.initResolve;
  ...
  async function getExposesMap() {
    exposesMapPromise ??= __vitePreload(() => import('./assets/virtualExposes-BIWYcA7-.js'),true              ?[]:void 0).then((mod) => mod.default ?? mod);
